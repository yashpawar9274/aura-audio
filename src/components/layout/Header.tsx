        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/cart">
            <Button variant="ghost" size="icon" className="relative">
              ...
              {itemCount > 0 && (
                <span className="absolute -top-1 -right-1 h-5 w-5 rounded-full bg-foreground text-background text-xs font-medium flex items-center justify-center animate-scale-in">
                  {itemCount}
                </span>
              )}
            </Button>
